...
define('MACHUPICCHU_LINK','machupicchu-es');
...
define('FIRST_NAME_TEXT','Nombres');
define('LAST_NAME_TEXT','Apellidos');
define('SUBJECT_TEXT','tema');
...
define('JUST_REQUEST_TEXT','Solo quiero Consultar');
define('HOW_DID_YOU_FIND_US_TEXT','Como nos encontro?');
define('SEARCH_ENGINE_TEXT','Google');
...
define('DIFFICULTY_TEXT','Dificultad: ');
define('USD__TEXT','USD: ');
define('HARD_TEXT','Dificil');
define('MEDIUM_TEXT','Media');
define('EASY_TEXT','Facil');
