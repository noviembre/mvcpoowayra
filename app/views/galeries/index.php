                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php foreach($data['galeria'] as $gale) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo URLROOT; ?>/galeries/edit/<?php echo $gale->gid; ?>"><img src="<?php echo URLROOT; ?><?php echo $gale->gruta; ?>" alt="" class="img-responsive" style="height: 50px" width="70px"></a></td>
