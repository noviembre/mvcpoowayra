...
class Ture {
    ...
    public function listarTourSpanishAll(){
        $this->db->query("SELECT * FROM tdetalles a INNER JOIN tours b
                            ON a.tid=b.tid WHERE b.tid IS NOT NULL  AND lang = 'es'
    ...
    public function agregarTourDetalles($data){
        ...
        $this->db->query("
                  INSERT INTO tdetalles ( tid,descripcion,incluye,noincluye,full_itinerario) 
                  VALUES (:tid,:descripcion,:incluye,:noincluye,:ifull)");
