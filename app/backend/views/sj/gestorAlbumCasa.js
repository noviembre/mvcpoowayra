...
Agregar Foto
=============================================*/
$("#casabtnAgregarFoto").click(function(){

    $("#casabtnAgregarFoto").hide(400);//ocultar el div de fotos
    $("#casabtnVolver").toggle(400);// muestra el boton
    $("#ordenarTextSlide").toggle(400);// muestra el boton
    $("#casaContenedorZ").toggle(400);// muestra el div paara arrastrar fotos


})

if($("#casaContenedorAgregar").html() == 0){
    $("#casaContenedorAgregar").css({"height":"150px"});
} else{
    $("#casaContenedorAgregar").css({"height":"auto"});
...
$("#casaContenedorAgregar").on("dragover", function(e){

    e.preventDefault();
    e.stopPropagation();
    // 2.Cuando arrastre una img su fondo cambiara por un patron
    $("#casaContenedorAgregar").css({"background":"url(views/images/pattern.jpg)"})
...
$("#casaContenedorAgregar").on("drop", function(e){

    e.preventDefault();
    e.stopPropagation();
    // 4.Cuando SUELTE una img su fondo cambiara por un patron BLANCO
    $("#casaContenedorAgregar").css({"background":"white"})
...
// Validar tamaño de la imagen
    ...
    if(Number(imagenSize) < 2000000 && imagenType == "image/jpeg" || imagenType == "image/png") {
        ...
        $.ajax({
            url:"views/ajax/gestorAlbumCasa.php",
            method: "POST",
            data: datos,
            cache: false,
            contentType: false,
            ...
            beforeSend: function(){
                ...
                $("#casaContenedorAgregar").before('<img src="views/images/status.gif" id="status">');
            ...
            success: function(respuesta){
                ...
                if(respuesta == 0){
                    ...
                    $("#casaContenedorAgregar").before('<div class="alert alert-warning alerta text-center">La imagen es inferior a 1600px * 600px</div>')
                    ...
                    $("#casaContenedorAgregar").append('<li class="bloqueSlide"><span class="fa fa-times eliminarSlide"></span><img src="'+respuesta["ruta"].slice(6)+'"></li>');
